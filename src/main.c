//***********************************************************************************
//*
//* This is the main function for the ipole code
//*
//***********************************************************************************
...
int main(int argc, char *argv[]) 
{
  ...
  // get time before running the computation
...
#pragma omp parallel
  ...
  // Specify field of view (FOV)
  if (params.fovx_dsource != 0.0) {
    //////////////////////////////////////////////////////////////////////////////
  ...
  // run in check mode if necessary
  if (params.perform_check) {
    fprintf(stderr, "Running in check mode...\n");
  }

  // calculate the time needed for initialization
...
// print out stats of the radiative transfers
void print_image_stats(double *image, double *imageS, size_t nx, size_t ny, Params params, double scale)
{
