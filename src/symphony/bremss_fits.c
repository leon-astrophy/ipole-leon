//**************************************************************************
//*
//* function for fitting bremsstrahlung emission function of electrons 
//*
//**************************************************************************
...
// include header files for maxwell distributions
...
// small number for theta, avoid coordinate singularity
...
{
  // don't include small angle emissions
  ...
  // Svensson 1982 as used in e.g. Straub 2012
    ...
    // choose according to theta = kt/mc^2 
    if (Thetae < 1) {
    ...
    // get emissitivity, electron-electron and electron-ion
...
/* thermal equilibrium, Absorptivities = emissitivity */
