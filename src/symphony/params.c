//*********************************************************************
//*
//* Initialising parameters for radiative transfer calculations
//*
//*********************************************************************
...
void setConstParams(struct parameters *params)
{
  ...
  /* Keys for the electronic distributions */
  ...
  //permittivity of free space, CGS units
  params->epsilon0  = 1./(4. * params->pi); 
