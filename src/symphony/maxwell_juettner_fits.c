//*******************************************************************************
//*
//* fitting formulae for the maxwellian electronic distribution functions
//*
//*******************************************************************************
...
double maxwell_juettner_rho_V(struct parameters * params)
{
  ...
  double fit_factor = 0;
  if (params->dexter_fit && k2 > 0) { 
    ////////////////////////////////////////////////////////
    // TODO Further limit the usage here to match grtrans
    ////////////////////////////////////////////////////////
